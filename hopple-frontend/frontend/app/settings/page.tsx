                      ...
                      <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                        ...
                        <div className="flex-1 space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              id="bio"
                              defaultValue="Product Manager at Acme Inc."
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="skills"
                          defaultValue="Project Management, UX Design, Marketing, Data Analysis"
                        />
                      </div>
                    </CardContent>
                    <CardFooter className="flex justify-end space-x-2">
                    ...
                    <CardContent className="space-y-4">
                      {[
                        ...
                        },
                        {
                          ...
                          description:
                            "Get notified about AI agent automated actions",
                        },
                        {
