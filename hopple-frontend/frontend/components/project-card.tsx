...
export function ProjectCard({ title, description, progress, dueDate, tasks, members, agentStatus }: ProjectCardProps) {
  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardFooter className="flex items-center justify-between border-t p-4">
        ...
        <div
          className={`flex items-center gap-1.5 text-xs ${agentStatus === "active" ? "text-emerald-500" : "text-muted-foreground"}`}
        >
